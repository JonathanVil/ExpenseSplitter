        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8 items-center">
                    <a href="/" class="text-white hover:text-gray-200 px-3 py-2 rounded-md text-md font-medium"
                    ...
                    {#if $authStore.isAuthenticated}
                        <a href="/dashboard"
                           class="text-white hover:text-gray-200 px-3 py-2 rounded-md text-md font-medium"
                           class:underline={$page.url.pathname === '/dashboard'}>
                            Dashboard
                        </a>
                        <a href="/groups"
                           class="text-white hover:text-gray-200 px-3 py-2 rounded-md text-md font-medium"
                           class:underline={$page.url.pathname === '/groups'}>
                            Groups
                        </a>
                    {/if}
                </div>
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
                {#if $authStore.isAuthenticated}
                    <div class="ml-3 relative group">
                        ...
                        <div class="hidden group-hover:block hover:block absolute right-0 pt-2 w-48 py-1 bg-white rounded-md shadow-lg z-10">
                ...
                {:else}
                    <div class="flex space-x-4">
                        ...
                        <a href="/register"
                           class="bg-white text-blue-600 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium">
                            Register
                        </a>
                    </div>
                {/if}
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                {#if $authStore.isAuthenticated}
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <a href="/settings"
                           class="block px-4 py-2 text-base font-medium text-white hover:text-gray-200">
                            Settings
                        </a>
                        <button on:click={logout}
                                class="w-full text-left block px-4 py-2 text-base font-medium text-white hover:text-gray-200">
                            Sign out
                        </button>
                    </div>
                {:else}
                    <div class="mt-3 space-y-1 px-2">
                        <a href="/login"
                           class="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200">
                            Sign in
                        </a>
                        <a href="/register"
                           class="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200">
